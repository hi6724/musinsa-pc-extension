  ...
  return `
    ...
    >
      <div class='category__sc-rb2kzk-5 hWLdIX'>
       ...
       ${
         isLiked
           ? `<button type="button" class="category__sc-1xj7o0v-2 OvWlJ gtm-catch-click active" data-gtm-action="like.product.cancel" data-gtm-cd-23="PLP_goods" data-gtm-cd-19="button" data-gtm-cd-20="/category" data-gtm-cd-21="3" data-gtm-category="PLP_goods" data-gtm-label="4240536"><svg width="1em" height="1em" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ff0000" class="category__sc-1xj7o0v-0 dREizi"><path d="M24.1159 7.60884C21.9708 5.46372 18.4929 5.46372 16.3477 7.60884L16 7.95658L14.9765 8.98003L13.6523 7.65578C11.5072 5.51066 8.02923 5.51065 5.88411 7.65578C3.73899 9.8009 3.73899 13.2788 5.88411 15.424L14.9991 24.539L18.5247 21.0134C18.6733 20.8647 18.8126 20.7102 18.9424 20.5505L24.1159 15.377C26.261 13.2319 26.261 9.75397 24.1159 7.60884Z" stroke="currentColor" vector-effect="non-scaling-stroke"></path></svg><svg width="1em" height="1em" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffffff" class="category__sc-1xj7o0v-1 eGmYVg"><path d="M24.1159 7.60884C21.9708 5.46372 18.4929 5.46372 16.3477 7.60884L16 7.95658L14.9765 8.98003L13.6523 7.65578C11.5072 5.51066 8.02923 5.51065 5.88411 7.65578C3.73899 9.8009 3.73899 13.2788 5.88411 15.424L14.9991 24.539L18.5247 21.0134C18.6733 20.8647 18.8126 20.7102 18.9424 20.5505L24.1159 15.377C26.261 13.2319 26.261 9.75397 24.1159 7.60884Z" stroke="currentColor" vector-effect="non-scaling-stroke"></path></svg></button>`
           : `<button
          class='category__sc-1xj7o0v-2 OvWlJ gtm-catch-click '
          type='button'
          data-gtm-action='like.product.ok'
          data-gtm-cd-23='PLP_goods'
          data-gtm-cd-19='button'
          data-gtm-cd-20='/category'
          data-gtm-cd-21='3'
          data-gtm-category='PLP_goods'
          data-gtm-label='${goodsNo}'
        >
          <svg
            class='category__sc-1xj7o0v-0 fhBDob'
            width='1em'
            height='1em'
            viewBox='0 0 30 30'
            fill='none'
          ...
          <svg
            class='category__sc-1xj7o0v-1 eGmYVg'
            width='1em'
            height='1em'
            viewBox='0 0 30 30'
            fill='none'
